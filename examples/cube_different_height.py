...
mesh1 = pv.Cube(center=(-10,0,5), x_length=10, y_length=10, z_length=10)
mesh2 = pv.Cube(center=(10,0,7.5), x_length=10, y_length=10, z_length=15)
meshes = [mesh1, mesh2]
...
out_path = r"C:\Users\antwi87\Downloads\slicerTest2\test2"
